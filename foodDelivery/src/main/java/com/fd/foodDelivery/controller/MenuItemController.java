...
public class MenuItemController {
	...
	public ResponseEntity<Object> getMenuItemsByRestaurant(@PathVariable int restaurantId){
		try {
			List<MenuItem> menuItems = service.getMenuItemsByRestaurant(restaurantId);
